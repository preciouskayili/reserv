    ...
    <main className="min-h-screen bg-background lg:grid lg:grid-cols-[minmax(340px,0.85fr)_minmax(0,1.15fr)]">
      ...
      <section className="flex items-center justify-center px-6 py-10 lg:px-12 lg:py-16 xl:px-20">
        <div className="w-full max-w-[600px]">
          ...
          <p className="mt-2 text-[13px] leading-6 text-muted-foreground">{cancelled ? "No payment can be made for this reservation." : "Review your booking and choose a payment method."}</p>
          ...
          {!cancelled && preview && <div role="status" className="mt-7 rounded-3xl bg-accent p-7">
            ...
            <h3 className="text-[21px] font-semibold tracking-tight text-primary">{preview === "adjusted" ? "Payment needs review" : preview === "paid" ? "Payment confirmed" : "Receipt submitted"}</h3>
